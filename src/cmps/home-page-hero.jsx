export function HomePageHero() {
    return (
        <section className='home-page-hero main-layout full'>
            <div className='flex'>
                <svg className='design-pattern-hero2 full' xmlns='http://www.w3.org/2000/svg' width='200' height='200' viewBox='100 0 200 200'>
                ...
                <h1 className='hero-header'>
                    Find the <br /> best <span className='talent-heading'>talent</span>{' '}
                </h1>
                <div className='flex column'>
                    <div className='design-pattern-rec'></div>
                    <p className='hero-description'>
                        Finding the right people and building high performing teams can be hard. Most companies aren’t tapping into the abundance of global talent. We’re about to change that.
                    </p>
                    <div className='flex design-pattern-hero'>
