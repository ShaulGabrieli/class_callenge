export function SuccessStoriesList() {
    return (
        <div className='success-stories-list flex'>
            <div className='success-preview flex column justify-center align-center'>
                <svg className='preview-quotes' xmlns='http://www.w3.org/2000/svg' width='67' height='56'>
                    <path
                        fill='#2c6269'
