export function DetailsPreview() {
    return (
        <div className='details-preview flex column'>
            <div className='detail flex align-center'>
                <div className='detail-img'>
                    <svg className='img-circle' xmlns='http://www.w3.org/2000/svg' width='65' height='72'>
                ...
                <div className='detail-desc'>
                    <h2 className='preview-heading'>Experienced Individuals</h2>
                    <p className='preview-desc'>Our network is made up of highly experienced professionals who are passionate about what they do.</p>
                </div>
            </div>
            <div className='detail flex align-center'>
                <div className='detail-img'>
                    <svg className='img-circle' xmlns='http://www.w3.org/2000/svg' width='72' height='72'>
                ...
                <div className='detail-desc'>
                    <h2 className='preview-heading'>Easy to Implement</h2>
                    <p className='preview-desc'>Our processes have been refined over years of implementation meaning our teams always deliver.</p>
                </div>
            </div>
            <div className='detail flex align-center'>
                <div className='detail-img'>
                ...
                <div className='detail-desc'>
                    <h2 className='preview-heading'>Enhanced Productivity</h2>
                    <p className='preview-desc'>Our customized platform with in-built analytics helps you manage your distributed teams.</p>
                </div>
            </div>
        </div>
    )
